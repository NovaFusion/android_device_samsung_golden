...
/**
 * \file   AFMNmfMpc_Encoder.h
 * \brief  
 * \author ST-Ericsson
 */
/*****************************************************************************/
#ifndef _AFM_ENCNMFPROCESSINGCOMP_H_
#define _AFM_ENCNMFPROCESSINGCOMP_H_
...
class AFMNmfMpc_Encoder: public AFMNmfMpc_ProcessingComp {
public:
    
    AFMNmfMpc_Encoder(ENS_Component &enscomp) 
            : AFMNmfMpc_ProcessingComp(enscomp), mNmfil(0), mNmfBitstreamLib(0), 
            mMemory_buffer_in(0), mMemory_buffer_out(0)  {
        }

    AFM_API_IMPORT virtual OMX_ERRORTYPE construct(void);

protected:
	// handle of NMF component which provides the encoder interface
...
private:
    ...
    Iencoders_streamed_configure        mIconfigure;
...
#endif // _AFM_ENCNMFPROCESSINGCOMP_H_
